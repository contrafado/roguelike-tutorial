            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_chance < 70:
                    ...
                    item_component = Item(use_function=cast_fireball, targeting=True, 
                                          targeting_message=Message('Left click a target to incinerate, or right click to cancel.', libtcod.light_cyan),
                                          damage=12, radius=3)
                    item = Entity(x, y, '#', libtcod.red, 'Fireball Scroll', render_order=RenderOrder.ITEM, item=item_component)
                elif item_chance < 90:
                    item_component = Item(use_function=cast_confuse, targeting=True, targeting_message=Message(
                                         'Left click to confuse an enemy, or right click to cancel.', libtcod.light_cyan))
